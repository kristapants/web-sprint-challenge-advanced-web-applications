...
`obfuscating data, like account numbers, passwords, IDs, into a string that, on it's own is meaningless, but can point towards the actual value.`
2. What steps can you take in your web apps to keep your data secure?
`tokenization, encryption, HTTPS, `
3. Describe how web servers work.
` a web server, a server, the cloud, all just mean another computer, somewhere else. It broadcasts the information you give it (like a website) to an IP address which can be interpreted as a URL by DNS.`
